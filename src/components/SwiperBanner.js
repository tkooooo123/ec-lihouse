...
function SwiperBanner() {
    ...
    return (
        ...
        >
            ...
            <SwiperSlide>
                <img src="https://article.murata.com/sites/default/files/styles/large/public/static/ja-jp/images/article/iot-changes-life-with-pets/iot-changes-life-with-pets-main.jpg?itok=fXIwQlD2" alt="滿額免運" />
                <div className='transport-text text-center text-primary'>
                    <img src="https://www.svgrepo.com/download/22694/delivery-truck.svg" style={{ width: '50px', height: '50px' }} alt="運輸icon" />
            ...
            <SwiperSlide>
                <img src="https://i.imgur.com/SV3Daha.jpeg" alt="新品上市" style={{ objectFit: 'cover', objectPosition: 'left top' }} />
